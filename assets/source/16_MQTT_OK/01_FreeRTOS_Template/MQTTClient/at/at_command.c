...
void MQTT_Client_Task(void *params)
{
	...
	/* 初始化消息结构体变量 msg，该变量存放要发布的消息 */
    mqtt_message_t msg;      
    memset(&msg, 0, sizeof(msg));  
    msg.payload = "This is a test message from STM32F103C8T6";  // 构造要上报的消息
    ...
    mqtt_set_host(client, "47.114.187.247");        // 百问网 iot.100ask.net 服务器 IP
//    mqtt_set_host(client, "192.168.0.202");       // 同一局域网内的服务器 IP
